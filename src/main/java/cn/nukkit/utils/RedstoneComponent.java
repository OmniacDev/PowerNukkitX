...
public interface RedstoneComponent {
    ...
    default void updateAroundRedstone(@NotNull Set<BlockFace> ignoredFaces) {
        if (this instanceof Locator) updateAroundRedstone((Locator) this, ignoredFaces);
    }
     ...
     * @param ignoredFaces The faces, that shouldn't get updated.
     */
    static void updateAroundRedstone(@NotNull Locator pos, @Nullable BlockFace... ignoredFaces) {
        if (ignoredFaces == null) ignoredFaces = new BlockFace[0];
     ...
     * @param ignoredFaces The faces, that shouldn't get updated.
     */
    static void updateAroundRedstone(@NotNull Locator pos, @NotNull Set<BlockFace> ignoredFaces) {
    ...
    default void updateAllAroundRedstone(@NotNull Set<BlockFace> ignoredFaces) {
        if (this instanceof Locator pos) updateAllAroundRedstone(pos, ignoredFaces);
    }
     ...
     * @param ignoredFaces The faces, that shouldn't get updated.
     */
    static void updateAllAroundRedstone(@NotNull Locator pos, @Nullable BlockFace... ignoredFaces) {
        if (ignoredFaces == null) ignoredFaces = new BlockFace[0];
     ...
     * @param ignoredFaces The faces, that shouldn't get updated.
     */
    static void updateAllAroundRedstone(@NotNull Locator pos, @NotNull Set<BlockFace> ignoredFaces) {
