...
public final class EnchantmentHelper {
    ...
    public static List<PlayerEnchantOptionsPacket.EnchantOptionData> getEnchantOptions(LevelPosition tablePos, Item input, int seed) {
    ...
    private static int countBookshelves(LevelPosition tablePos) {
