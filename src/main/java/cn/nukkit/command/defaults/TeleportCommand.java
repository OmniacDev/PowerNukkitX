    ...
    public int execute(CommandSender sender, String commandLabel, Map.Entry<String, ParamList> result, CommandLogger log) {
        ...
        switch (result.getKey()) {
            case "->Entity" -> {
                ...
                Transform target = destination.get(0).setYaw(victim.getYaw()).setPitch(victim.getPitch());
            ...
            case "Entity->Pos(FacingPos)" -> {
                ...
                LevelPosition pos = list.getResult(1);
                LevelPosition lookAtPosition = list.getResult(3);
                boolean checkForBlocks = false;
                if (list.hasResult(4)) {
                    checkForBlocks = list.getResult(4);
                }
            ...
            case "Entity->Pos(FacingEntity)" -> {
                ...
                LevelPosition lookAtPosition = lookAtEntity.get(0);
                boolean checkForBlocks = false;
                if (list.hasResult(4)) {
                    checkForBlocks = list.getResult(4);
                }
            ...
            case "->Pos" -> {
                ...
                LevelPosition pos = list.getResult(0);
                double yRot = sender.getLocation().pitch;
                if (list.hasResult(1)) {
            ...
            case "->Pos(FacingPos)" -> {
                ...
                LevelPosition pos = list.getResult(0);
                LevelPosition lookAtPosition = list.getResult(2);
                boolean checkForBlocks = false;
                if (list.hasResult(3)) {
                    checkForBlocks = list.getResult(3);
                }
