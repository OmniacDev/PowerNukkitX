    ...
    public void onSlotChange(int index, Item before, boolean send) {
        ...
        if (index == 0) {
            if (this.getSaddle().isNull()) {
                ...
                this.getHolder().level.addLevelSoundEvent(this.getHolder().position, LevelSoundEventPacket.SOUND_SADDLE, -1, this.getHolder().getIdentifier(), false, false);
            ...
            if (!this.getHorseArmor().isNull()) {
                this.getHolder().level.addSound(this.getHolder().position, Sound.MOB_HORSE_ARMOR);
            }
