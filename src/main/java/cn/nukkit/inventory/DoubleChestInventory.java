...
public class DoubleChestInventory extends ContainerInventory {
    ...
    public void onOpen(Player who) {
        ...
        if (this.getViewers().size() == 1) {
            ...
            if (level != null) {
                level.addSound(this.left.getHolder().position.add(0.5, 0.5, 0.5), Sound.RANDOM_CHESTOPEN);
            ...
            if (level != null) {
                level.addSound(this.right.getHolder().position.add(0.5, 0.5, 0.5), Sound.RANDOM_CHESTOPEN);
    ...
    public void onClose(Player who) {
        if (this.getViewers().size() == 1) {
            ...
            if (level != null) {
                level.addSound(this.right.getHolder().position.add(0.5, 0.5, 0.5), Sound.RANDOM_CHESTCLOSED);
            ...
            if (level != null) {
                level.addSound(this.left.getHolder().position.add(0.5, 0.5, 0.5), Sound.RANDOM_CHESTCLOSED);
