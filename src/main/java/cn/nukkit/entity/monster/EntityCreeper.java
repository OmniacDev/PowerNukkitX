...
import cn.nukkit.entity.mob.EntityCat;
import cn.nukkit.entity.mob.EntityOcelot;
 ...
 * @author Box.
 */
public class EntityCreeper extends EntityMonster implements EntityWalkable, EntityInteractable {
    @Override
    @NotNull
