        ...
        if (isAlive()) {
            ...
            if ((b.equals(BlockID.SAND) ||
                ...
                if (aliveTick > sandAliveTick) {
                    aliveTick = 0;
                    level.addParticle(new DestroyBlockParticle(this.position, blockState.toBlock()));
                    this.close();
                    dropItems();
                }
            }
            ...
            Vector3 pos = (new Vector3(this.position.x - 0.5, this.position.y, this.position.z - 0.5)).round();
            ...
            if (onGround) {
                ...
                Vector3 floorPos = (new Vector3(this.position.x - 0.5, this.position.y, this.position.z - 0.5)).floor();
