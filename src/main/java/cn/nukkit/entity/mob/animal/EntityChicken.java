...
public class EntityChicken extends EntityAnimal implements EntityWalkable {
    ...
    public void updateMovement() {
        //补充鸡的缓慢无伤落地特性
        if (!this.onGround && this.motion.y < -0.08f) {
            this.motion.y = -0.08f;
        ...
        return new BehaviorGroup(
                ...
                Set.of(
                        ...
                        new Behavior(entity -> {
                            ...
                            entity.getLevel().dropItem(entity.position, Item.get(Item.EGG));
                            entity.getLevel().addSound(entity.position, Sound.MOB_CHICKEN_PLOP);
                            return false;
                        }, any(
                                all(
