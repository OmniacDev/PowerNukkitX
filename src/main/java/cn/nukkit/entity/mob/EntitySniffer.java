...
public class EntitySniffer extends EntityAnimal {
    ...
    public IBehaviorGroup requireBehaviorGroup() {
        return new BehaviorGroup(
                ...
                Set.of(
                        ...
                        new Behavior(new EntityBreedingExecutor<>(EntitySniffer.class, 16, 100, 0.5f), entity -> entity.getMemoryStorage().get(CoreMemoryTypes.IS_IN_LOVE), 3, 1),
    ...
    public boolean isBreedingItem(Item item) {
        return item.getId().equals(Item.TORCHFLOWER_SEEDS);
    }
}
