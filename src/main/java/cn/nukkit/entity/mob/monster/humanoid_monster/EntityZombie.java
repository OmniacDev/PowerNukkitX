...
public class EntityZombie extends EntityHumanoidMonster implements EntityWalkable, EntitySmite {
    @Override
    @NotNull
    ...
    protected void transform() {
        this.close();
        getEquipment().getContents().values().forEach(i -> this.level.dropItem(this.position, i));
