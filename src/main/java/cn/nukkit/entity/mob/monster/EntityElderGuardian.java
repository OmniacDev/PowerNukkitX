        ...
        return new BehaviorGroup(
                ...
                Set.of(
                        ...
                        new Behavior(new GuardianAttackExecutor(CoreMemoryTypes.NEAREST_PLAYER, 0.3f, 15, true, 60, 40), all(
                                ...
                                entity -> entity.getMemoryStorage().get(CoreMemoryTypes.NEAREST_PLAYER) != null && getLevel().raycastBlocks(entity.position, entity.getMemoryStorage().get(CoreMemoryTypes.NEAREST_PLAYER).position).stream().allMatch(Block::isTransparent)
                        ), 3, 1),
