...
public class EntityEnderman extends EntityMonster implements EntityWalkable {
                ...
                Set.of(
                        ...
                        new Behavior(new MeleeAttackExecutor(CoreMemoryTypes.ATTACK_TARGET, 0.45f, 64, true, 30), all(
                                ...
                                any(
                                        ...
                                        entity -> getMemoryStorage().get(CoreMemoryTypes.ATTACK_TARGET) instanceof EntityMob
                                )
                        ), 3, 1),
