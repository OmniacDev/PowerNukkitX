...
import cn.nukkit.entity.monster.EntityGolem;
 ...
 */
public class EntityZombiePigman extends EntityHumanoidMonster implements EntityWalkable, EntitySmite { //Mojang seems to kept the old name?
    @Override
    @NotNull
